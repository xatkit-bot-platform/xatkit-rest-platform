...
public class DeleteJsonRequestWithBody extends JsonRestRequest<JsonElement> {
     ...
     *                        the request
     */
    public DeleteJsonRequestWithBody(RestPlatform platform, StateContext context, String restEndpoint,
                                     Map<String, Object> queryParams, Map<String, String> pathParams,
                                     JsonElement requestBody, Map<String, String> headers) {
        super(platform, context, MethodKind.DELETE, restEndpoint, queryParams, pathParams, requestBody,
