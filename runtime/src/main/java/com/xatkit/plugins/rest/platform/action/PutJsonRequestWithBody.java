...
public class PutJsonRequestWithBody extends RestRequest<JsonElement, JsonElement> {
     ...
     *                        the request
     */
    public PutJsonRequestWithBody(RestPlatform runtimePlatform, XatkitSession session, String restEndpoint,
                                  Map<String, Object> queryParams, Map<String, String> pathParams,
                                  JsonElement requestBody, Map<String, String> headers) {
        super(runtimePlatform, session, MethodKind.PUT, restEndpoint, queryParams, pathParams, requestBody, headers,
