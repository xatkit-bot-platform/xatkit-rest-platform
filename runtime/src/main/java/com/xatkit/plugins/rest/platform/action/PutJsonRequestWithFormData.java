 ...
 */
public class PutJsonRequestWithFormData extends RestRequest<JsonElement,JsonElement>  {
     ...
     */
    public PutJsonRequestWithFormData(RestPlatform runtimePlatform, XatkitSession session, String restEndpoint, Map<String, Object> queryParams, Map<String, String> pathParams, Map<String, String> headers, Map<String, Object> formParams ) {
        super(runtimePlatform, session, MethodKind.PUT, restEndpoint, queryParams, pathParams,null, headers,formParams);
