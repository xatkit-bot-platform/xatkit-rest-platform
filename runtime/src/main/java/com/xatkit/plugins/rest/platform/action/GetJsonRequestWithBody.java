...
public class GetJsonRequestWithBody extends RestRequest<JsonElement,JsonElement>  {
	 ...
	 *                        the request
     */
    public GetJsonRequestWithBody(RestPlatform runtimePlatform, XatkitSession session, String restEndpoint, Map<String, Object> queryParams, Map<String, String> pathParams, JsonElement requestBody, Map<String, String> headers ) {
