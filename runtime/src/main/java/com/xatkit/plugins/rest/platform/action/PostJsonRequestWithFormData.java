...
public class PostJsonRequestWithFormData extends RestRequest<JsonElement,JsonElement>  {
     ...
     */
    public PostJsonRequestWithFormData(RestPlatform runtimePlatform, XatkitSession session, String restEndpoint, Map<String, Object> queryParams, Map<String, String> pathParams, Map<String, String> headers, Map<String, Object> formParams ) {
