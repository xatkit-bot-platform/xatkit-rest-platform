...
public class PostJsonRequestWithFormData extends RestRequest<JsonElement,JsonElement>  {
    ...
    public PostJsonRequestWithFormData(RestPlatform runtimePlatform, XatkitSession session, String restEndpoint, Map<String, Object> queryParams, Map<String, Object> pathParams, Map<String, String> headers, Map<String, Object> formParams ) {
        super(runtimePlatform, session, MethodKind.POST, restEndpoint, queryParams, pathParams,null, headers,formParams);
