...
public class DeleteJsonRequestWithBody extends RestRequest<JsonElement,JsonElement>  {
	 ...
	 *                        the request
     */
    public DeleteJsonRequestWithBody(RestPlatform runtimePlatform, XatkitSession session, String restEndpoint, Map<String, Object> queryParams, Map<String, String> pathParams, JsonElement requestBody, Map<String, String> headers ) {
        super(runtimePlatform, session, MethodKind.DELETE, restEndpoint, queryParams, pathParams,requestBody, headers,Collections.emptyMap());
