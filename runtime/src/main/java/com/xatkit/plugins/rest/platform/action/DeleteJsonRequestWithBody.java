...
public class DeleteJsonRequestWithBody extends RestRequest<JsonElement,JsonElement>  {
    ...
    public DeleteJsonRequestWithBody(RestPlatform runtimePlatform, XatkitSession session, String restEndpoint, Map<String, Object> queryParams, Map<String, Object> pathParams, JsonElement requestBody, Map<String, String> headers ) {
